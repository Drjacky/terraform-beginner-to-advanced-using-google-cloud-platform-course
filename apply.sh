...
echo "SYNTAX = ./apply.sh <PATH_TO_CONFIG_FOLDER>"
echo "EXAMPLE = ./apply.sh first_project"
echo ""
...
# 3. Apply the changes (The -auto-approve flag is safe here)
echo "Running: terraform apply in $1"
